<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
 ...
 <li class="active"><a href="ecommerce-product-shop.html"><i class="la la-th-large"></i><span class="menu-title"
    data-i18n="Shop">Shop</span></a>
 </li>
 <li class=" nav-item"><a href="product_index.php"><i class="la la-list"></i><span class="menu-title"
    data-i18n="Product Detail">Product List</span></a>
 </li>
 <li class=" nav-item"><a href="category_index.php"><i class="la la-list"></i><span class="menu-title"
    data-i18n="Product Detail">Product Category</span></a>
 </li>
