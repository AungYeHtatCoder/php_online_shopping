...
$id = $_GET['id'];
$product_detail = $db->ProductShow($id);
// echo "<pre>";
    ...
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
     ...
     <div class="row breadcrumbs-top d-inline-block">
      <div class="breadcrumb-wrapper col-12">
       <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="product_index.php">Home</a>
        </li>
           ...
           <div class="col-xl-3 col-lg-3 col-md-6 mb-1">
            <div class="product-count pr-1">
             <div class="input-group">
              <input class="text-center count touchspin" type="text" value="1" <?= $product_detail->qty;?> />
             </div>
            </div>
           </div>
