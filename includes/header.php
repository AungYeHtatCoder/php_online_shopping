  ...
  <div class="navbar-header">
   <ul class="nav navbar-nav flex-row">
    ...
    <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo"
       alt="modern admin logo" src="admin/app-assets/images/logo/logo.png">
   ...
   <div class="collapse navbar-collapse" id="navbar-mobile">
    ...
    <ul class="nav navbar-nav float-right">
     ...
     <li class="dropdown dropdown-notification nav-item">
      <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell">
     ...
     <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
       data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">
        ...
        if(isset($_SESSION['id'])){echo $_SESSION['user_name'];}else{echo "Guest";}
        //if($auth->id): echo $auth->user_name; else: echo "Guest"; endif;
        ?>
       </span><span class="avatar avatar-online"><img src="admin/app-assets/images/portrait/small/avatar-s-19.png"
         alt="avatar"><i></i></span></a>
      <div class="dropdown-menu dropdown-menu-right">

       <a class="dropdown-item" href="#"><i class="ft-user"></i> Edit
        Profile</a>
       <?php if(!isset($_SESSION['id'])) :
        
        ?>
       <a class="dropdown-item" href="login_form.php"><i class="ft-clipboard"></i> Login</a>
       <?php else: ?>
       <a class="dropdown-item" href="login_form.php"><i class="ft-clipboard"></i> Login</a>
       ...
       <a class="dropdown-item" href="reg_form.php"><i class="ft-clipboard"></i> Register</a>
       <?php //} ?>

       <a class="dropdown-item" href="#"><i class="ft-check-square"></i> Task</a>
       <div class="dropdown-divider"></div><a class="dropdown-item" href="_actions/logout.php"><i class="ft-power"></i>
        Logout</a>
      </div>
     </li>
    </ul>
